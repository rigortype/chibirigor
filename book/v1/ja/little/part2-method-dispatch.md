...
戻り型、**有って引数が合わなければ**診断。どの道も出発点は同じ「レシーバの型とメソッド名で表を
引けたか」です。
...
> **この章の実装** → [`impls/dist/part2/lib`](https://github.com/rigortype/chibirigor/tree/master/impls/dist/part2/lib)
