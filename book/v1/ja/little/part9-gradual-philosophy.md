...
理屈は素直です。一部でも型を見失っているなら、そのユニオン型について断言はできない。`1 | untyped`
...
組み上がった推論器が*動く様子*をコマ送りで眺めたくなったら、付録 [a3](../appendix/a3-tooling.md) の
`trace` を覗いてみてください ― 各 Part で作った部品が、1 つの式の上でどう連動するかを目で追えます。
