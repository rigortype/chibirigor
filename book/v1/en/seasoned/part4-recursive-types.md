...
calls in *itself*, argument-like. The Little volume handled arrays and hashes as *finite* structures,
but real data includes things that contain themselves — JSON, trees, linked lists, streams. These
...
> **Column: passing `symbolize_names: true` as a literal changes the type**
>
...
> **Column: the verdict of an HKT conditional type is also three-valued `:yes/:no/:maybe`**
>
