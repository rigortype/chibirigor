...
> parameters, so it didn't need to be aware of `⇐` (checking) independently. chibirigor, dealing
> with annotation-free Ruby, had to clearly separate `⇒` and `⇐` — that's bidirectional typing.
...
> **Column: the `param:` directive does two jobs**
>
