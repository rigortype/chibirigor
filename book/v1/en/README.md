...
> This directory is the **clean English edition** (transcreated from the Japanese original
...
- The only prerequisite is Ruby. There is **no math or proof in the Little volume** — the
  Seasoned volume takes those on directly.
...
- **The Little chibirigor** ([`little/`](little/README.md)) — the gentle introduction. Build a
  ...
  **The code runs to completion within the Little volume**; the deeper dives (the formal
  theory) are handed to the Seasoned volume.
...
## How to read each chapter — the three voices

Each chapter is written as a small **three-voice piece** — "**① type theory ↔ ② Ruby/RBS ↔
③ Rigor's implementation**" (the Japanese calls this 三題噺; [Part 0](little/part0-introduction.md)
explains it in full).
