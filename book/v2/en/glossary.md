...
(Terms that appear in both volumes are placed where you *first* meet them, on the Little side,
with the chapter of first appearance noted in v1 numbering. Cross-volume references are also
organized in the [appendices](appendix/).)
...
- **`Dynamic` / `untyped`** 〔Little P1〕 — the mark for "the type was lost." The heart of
  gradual typing. The cross-language table and the axis-A / axis-B discussion are in appendix
  [a1](appendix/a1-special-types.md) (the catalog of special types).
...
- **refinement carrier** 〔Seasoned P6 / Rigor-specific〕 — a *type refined by a predicate*,
  ...
  appendix [a2-6](appendix/a2-narrowing-patterns.md)**; individual narrowing patterns are also
  in appendix [a2](appendix/a2-narrowing-patterns.md). Seasoned P6 §6-1.
- **`Difference` type** 〔Rigor-internal〕 — a type carrier for "the set of values in `A` with
  ...
  structure are canonical in appendix [a2-6](appendix/a2-narrowing-patterns.md).**
