...
> 参考書（『しくみ』/TAPL）の対応は [付録 a4](../appendix/a4-bibliography.md) に一元化しています（どちらも必読ではありません）。
...
`subtype.rb`（Part 2）、`subst.rb`（Part 3）、`mu_typeeq.rb`（Part 4）、`unification.rb`（Part 5）、`fact_invalidation.rb`（Part 6）の 5 本です。
