...
（前編＝The Little、後編＝The Seasoned。初出の章は v1 の章立てで併記。巻をまたぐ参照情報は
[付録](appendix/) にも整理があります。）
...
- **部分型（subtype, `<:`）**〔前編 P7／後編 P2〕… 「値が期待の型の箱に入る」関係。TAPL 15 章。
...
- **FactStore**〔前編 P5（素朴版）／後編 P6（完全版）〕… フロー感応な「事実」の置き場。
